...
class HearingConfirmation extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Hearing Confirmation: Case# ' . $this->event->case_num,
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.new-hearing-confirmation',
            with: [
