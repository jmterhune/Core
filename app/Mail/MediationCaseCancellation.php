...
class MediationCaseCancellation extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Mediation Hearing Cancellation: Case# ' . $this->case->c_caseno,
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.new-mediationcase-cancellation',
            with: [
