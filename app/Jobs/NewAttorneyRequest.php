...
class NewAttorneyRequest implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(array $request, Attorney $attorney)
    {
        $this->data = $request;
    ...
    public function handle()
    {
        if(env('APP_ENV') != "staging"){
            ...
            $username  = "Circuit.Apps@flcourts18.org"; // replace this with your registered email
            $token     = "Q6L20JhHkQMLEaO2zEXAUzW8XOETtg7dQNM9BVkH"; // replace this with your token
            ...
            $newTicket = $client->tickets()->create([
                ...
                'comment'  => [
                    'body' =>
                        'Attorney ' . $this->attorney->name . ' was unable to find the Attorney below in our database.' . PHP_EOL . PHP_EOL .
                        ...
                        '**Reply Email:**'  . $this->attorney->email->first()->email
                ],
                'tags' => [
                    'JACS',
                    'Attorney Request'
