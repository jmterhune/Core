...
<div class="row">
    <label><strong>Petitioner : &nbsp;&nbsp;</strong></label>
    <label> {{implode(", ", \App\Models\Party::where('mediation_case_id', $case->id)->where('type', 'petitioner')->pluck('name')->toArray())}}</label>
</div>
<div class="row">
    <label><strong>Respondent :&nbsp;&nbsp;</strong></label>
    <label> {{implode(", ", \App\Models\Party::where('mediation_case_id', $case->id)->where('type', 'respondent')->pluck('name')->toArray())}}</label>
</div>
<div class="row">
        ...
        <div class="form-row">
            ...
            <div class="col-3">
                <select name="paid_by" id="paid_by" class="form-control">
                    @if($case->respondent == 0)
                    <option selected="selected" value="Respondent">Respondent</option>
                    @endif
                    @if($case->petitioner == 0)
            ...
            @if($case->petitioner == 0 || $case->respondent == 0)
            <div class="col-2">
            ...
            <div class="modal-body">
                <form id="updatePaymentForm" class="updatePaymentForm">
                    ...
                    <div class="form-group">
                        ...
                        <select name="paid_by" id="paid_by" class="form-control">
                            <option selected="selected" value="Defendant">Respondent</option>
                            <option value="Plaintiff">Petitioner</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="paid_on">Date Paid</label>
                        <input type="text" class="form-control datepicker" id="paid_on" name="paid_on" value="">
                    </div>
                    ...
                    <script>
                        $(function() {
                             ...
                             dateFormat: 'mm/dd/yy' // Set the date format to MM/DD/YYYY
                            });
                                });
                            </script>
