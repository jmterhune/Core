    ...
    <form name="form1" method="post" id="form1" style="font-size: 18px; font-family:Arial; margin-left:20px; ">
        ...
        <div>
            ...
            <table style="width:700px; font-size:20px;font-weight:700;">
                ...
                <tr>
                    <td>
                        <b>Petitioner:<br /><br /> </b>
                    </td>
                    <td>
                        <b>
                            <!-- <span id="c_pltf_name">{{$case->c_pltf_name}}</span> <br /><br /> -->
                        <span id="c_pltf_name">{{ implode(", ", \App\Models\Party::where('mediation_case_id', $case->id)->where('type', 'petitioner')->pluck('name')->toArray()) }}</span> <br /><br />
                ...
                <tr>
                    <td>
                        <b>Petitioner Attorney:<br /><br /> </b>
                    </td>
                    <td>
                        <b>
                            <!-- <span id="p_a_name">{{@$case->PltfAttroney->name}}</span><br /><br /> -->

                            <span id="p_a_name">{{ \App\Models\Attorney::where('id', \App\Models\Party::where('mediation_case_id', $case->id)->where('type',  'petitioner')->first()->attorney_id)->first()->name ?? '' }}</span> <br /><br />
                ...
                <tr>
                    <td>
                        <b>Respondent:<br /><br /> </b>
                    </td>
                    <td>
                        <b>
                            <!-- <span id="c_def_name">{{$case->c_def_name}}</span> <br /><br /> -->
                            <span id="c_def_name">{{ implode(", ", \App\Models\Party::where('mediation_case_id', $case->id)->where('type', 'respondent')->pluck('name')->toArray()) }}</span> <br /><br />
                ...
                <tr>
                    <td>
                        <b>Respondent Attorney:<br /><br /> </b>
                    </td>
                    <td>
                        <b>
                            <!-- <span id="d_a_name">{{@$case->DefAttroney->name}}</span><br /><br /> -->

                            <span id="d_a_name">{{ \App\Models\Attorney::where('id', \App\Models\Party::where('mediation_case_id', $case->id)->where('type',  'respondent')->first()->attorney_id)->first()->name ?? '' }}</span> <br /><br />
                ...
                <table id="GridView1_ctl00" cellspacing="0" rules="all" border="1" style="border-collapse:collapse;font-family:Arial;font-size:14px;">
                    <tbody>
                        <tr id="GridView1_ctl01">
                            ...
                            <th id="GridView1_ctl01_ctl05" scope="col">Respondent FTA</th>
                            <th id="GridView1_ctl01_ctl06" scope="col">Petitioner FTA</th>
                        </tr>
