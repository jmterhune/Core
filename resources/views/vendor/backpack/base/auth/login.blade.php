...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <div class="col-12 text-center" ><img style="max-width: 250px;" src="../img/trlogo.png"></div>
            ...
            <div class="card">
				...
				<i class="la la-2x la-eye nav-icon toggle-pwd" style="margin: -34px 6px 0px 10px;float:right;position: relative;"></i>
...
{{--            @endif--}}
	...
	<script>
        $(".toggle-pwd").click(function(event){
            event.target.classList.toggle("la-eye-slash");
