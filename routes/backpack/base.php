    ...
    Route::group(
        ...
        function () {
            ...
            if (config('backpack.base.setup_auth_routes')) {
                ...
                Route::get('login', '\App\Http\Controllers\Admin\LoginController@showLoginForm')->name('backpack.auth.login');
                Route::post('login', '\App\Http\Controllers\Admin\LoginController@login');
                Route::get('logout', '\App\Http\Controllers\Admin\LoginController@logout')->name('backpack.auth.logout');
            ...
            if (config('backpack.base.setup_dashboard_routes')) {
                Route::get('dashboard', '\App\Http\Controllers\Admin\AdminController@dashboard')->name('backpack.dashboard');
